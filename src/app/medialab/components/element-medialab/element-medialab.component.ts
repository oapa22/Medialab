...
@Component({
    selector: 'medialab-element-medialab',
    templateUrl: './element-medialab.component.html',
    styleUrl: './element-medialab.component.css',
    standalone: false
})
export class ElementMedialabComponent implements AfterViewInit,OnInit{
